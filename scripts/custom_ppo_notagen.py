...
from rewards.rewards import score_source_structure_bars
...
from scripts.notagen_ppo_rewards import (
    ...
    _generated_patch_texts,
    _line_reward_components_from_metrics,
    _patch_char_spans,
    _project_reward_events_to_patches,
    _rollout_length_diagnostics,
    _rollout_length_summary,
    _rollout_sampling_summary,
    _score_total_reward_from_structural_breakdown,
    _single_pass_line_reward_components,
    _single_pass_line_rewards,
    _stream_line_end_patch_indices,
    _stream_line_spans,
    _strict_symbolic_reward_events,
    _terminal_patch_rewards,
    _terminal_similarity_component_rewards,
    generated_patch_completion_prefixes,
    patch_rewards_from_prefix_deltas,
